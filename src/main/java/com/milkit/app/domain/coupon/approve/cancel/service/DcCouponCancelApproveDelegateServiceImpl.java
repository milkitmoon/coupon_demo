...
@Slf4j
@Component
public class DcCouponCancelApproveDelegateServiceImpl implements CouponApproveDelegateService<CancelApprRequest, DcUseApprResponse>, CouponLogSupplier<CancelApprRequest> {
	...
	@Override
	public DcUseApprResponse approve(CancelApprRequest apprRequest, Coupon coupon, CouponLog couponLog) throws Exception {
